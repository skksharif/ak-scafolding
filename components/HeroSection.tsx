      ...
      <div className="relative mt-[50px] z-10 max-w-7xl mx-auto px-4 sm:mt-0 px-6 lg:px-8 text-center">
        <div className="animate-fade-scale">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mt-12">
            <button className="group bg-[#F36A2D] hover:bg-[#E85C24] text-white px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300 hover:scale-105  flex items-center space-x-3">
              <span>Request a Quote</span>
              <FaArrowRight className="group-hover:translate-x-1 transition-transform duration-300" />
            </button>
            
            <a href='#services' className="group border-2 border-[#F36A2D] text-white hover:bg-[#F36A2D] px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300 hover:scale-105 flex items-center space-x-3">
